...
PMAPS readmaps_code_app(char *bm);//读取maps文件
PMAPS readmaps_other(char *bm);//读取maps文件
PMAPS readmaps_v(char *bm);//读取maps文件
...
PMAPS BaseAddressSearch_QWORD(char *bm,int value,int *gs,long int BaseAddr,PMAPS pMap);//QWORD
...
PMAPS RangeMemorySearch_QWORD(char *bm,int from_value,int to_value,int *gs,PMAPS pMap);//QWORD
...
PMAPS MemorySearch_QWORD(char *bm,int value,int *gs,PMAPS pMap);  //内存搜索QWORD
...
PMAPS MemoryOffset_QWORD(char *bm,int value,long int offset,PMAPS pBuff,int *gs);//搜索偏移QWORD
...
PMAPS RangeMemoryOffset_QWORD(char *bm,int from_value,int to_value,long int offset,PMAPS pBuff,int *gs);//搜索偏移QWORD
...
int MemoryWrite_QWORD(char *bm,int value,PMAPS pBuff,long int offset);	//内存写入QWORD
...
int AddFreezeItem_QWORD(char *bm,long int addr,char *value);//QWORD
...
PMAPS RangeMemorySearch_QWORD(PACKAGENAME *bm,int from_value,int to_value,COUNT *gs,PMAPS pMap)//DWORD
{
	pid_t pid=getPID(bm);
	if (pid == 0)
	{
...
PMAPS MemoryOffset_QWORD(PACKAGENAME *bm,int value,OFFSET offset,PMAPS pBuff,COUNT *gs)//搜索偏移
{
	pid_t pid=getPID(bm);
	if (pid == 0)
	{
...
PMAPS RangeMemoryOffset_QWORD(PACKAGENAME *bm,int from_value,int to_value,OFFSET offset,PMAPS pBuff,COUNT *gs)//搜索偏移DWORD
{
	pid_t pid=getPID(bm);
	if (pid == 0)
	{
