...
public:
	...
	bool                                               bDontPaintWhenChildEmpty;                                 // 0x0AAA(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x5];                                       // 0x0AAB(0x0005) MISSED OFFSET
...
// 0x0170 (0x0970 - 0x0800)
class UWidgetComponent : public UMeshComponent
{
public:
	float                                              RTScale;                                                  // 0x0800(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetSpace                                       Space;                                                    // 0x0804(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetTimingPolicy                                TimingPolicy;                                             // 0x0805(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0806(0x0002) MISSED OFFSET
	class UClass*                                      WidgetClass;                                              // 0x0808(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x0810(0x0008) (Edit, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x0818(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x0819(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x081A(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x081C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0820(0x0008) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x0828(0x0008) (IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0830(0x0004) MISSED OFFSET
	bool                                               bDrawAtDesiredSize;                                       // 0x0834(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0835(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x0838(0x0008) (Edit, IsPlainOldData)
	bool                                               bReceiveHardwareInput;                                    // 0x0840(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x0841(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x6];                                       // 0x0842(0x0006) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x0848(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0850(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x0860(0x0010) (Edit, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x0870(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetBlendMode                                   BlendMode;                                                // 0x0874(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x0875(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x0876(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x1];                                       // 0x0877(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x0878(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData07[0x20];                                      // 0x0880(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x08A0(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA;                                    // 0x08A8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA_OneSided;                           // 0x08B0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x08B8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x08C0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                           // 0x08C8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                                  // 0x08D0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                           // 0x08D8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                                  // 0x08E0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x08E8(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInstanceDynamic*                    MaterialInstance;                                         // 0x08F0(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bAddedToScreen;                                           // 0x08F8(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x08F9(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x6];                                       // 0x08FA(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x0900(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x0908(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EWidgetGeometryMode                                GeometryMode;                                             // 0x090C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x090D(0x0003) MISSED OFFSET
	float                                              CylinderArcAngle;                                         // 0x0910(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x5C];                                      // 0x0914(0x005C) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnSetBrushAsyncComplete;                                  // 0x01C8(0x0010) (ZeroConstructor, InstancedReference)
	...
	struct FString                                     imageSrcPath;                                             // 0x01F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FVector2D                                   ScalePivot;                                               // 0x0208(0x0008) (Edit, IsPlainOldData)
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0210(0x0010) (Edit, ZeroConstructor, InstancedReference)
	struct FSoftObjectPath                             AsyncLoadResourcePath;                                    // 0x0220(0x0018)
	unsigned char                                      UnknownData00[0x20];                                      // 0x0238(0x0020) MISSED OFFSET
	float                                              HitTestAreaRadius;                                        // 0x0258(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsEnhancedImage;                                         // 0x025C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsUseEnhancedHitTest;                                    // 0x025D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFixOverScale;                                            // 0x025E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bVersionImg;                                              // 0x025F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenAlphaZero;                                  // 0x0260(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenColorZero;                                  // 0x0261(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAsyncLoadImageAsset;                                     // 0x0262(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	TMap<class UObject*, class UShareWidgetRT*>        SharedWidgetRTMap;                                        // 0x03F8(0x0050) (ZeroConstructor)
...
// 0x0210 (0x0540 - 0x0330)
class UWidgetInteractionComponent : public USceneComponent
{
public:
	struct FScriptMulticastDelegate                    OnHoveredWidgetChanged;                                   // 0x0330(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0340(0x0010) MISSED OFFSET
	int                                                VirtualUserIndex;                                         // 0x0350(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PointerIndex;                                             // 0x0354(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     TraceChannel;                                             // 0x0358(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0359(0x0003) MISSED OFFSET
	float                                              InteractionDistance;                                      // 0x035C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EWidgetInteractionSource                           InteractionSource;                                        // 0x0360(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableHitTesting;                                        // 0x0361(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShowDebug;                                               // 0x0362(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0363(0x0001) MISSED OFFSET
	struct FLinearColor                                DebugColor;                                               // 0x0364(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7C];                                      // 0x0374(0x007C) MISSED OFFSET
	struct FHitResult                                  CustomHitResult;                                          // 0x03F0(0x0098) (Transient, IsPlainOldData)
	...
	struct FHitResult                                  LastHitResult;                                            // 0x04A0(0x0098) (Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetInteractable;                             // 0x0538(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetFocusable;                                // 0x0539(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetHitTestVisible;                           // 0x053A(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
