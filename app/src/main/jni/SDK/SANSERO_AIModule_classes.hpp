...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x0498(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x0498(0x0001) (Edit, BlueprintVisible)
	...
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x04D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x04D8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x1];                                       // 0x04E8(0x0001) MISSED OFFSET
	bool                                               UseGameplayTasksComponent;                                // 0x04E9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShareNavigationSystem;                                   // 0x04EA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x04EB(0x0001) MISSED OFFSET
	struct FVector                                     ShareNavSysOffset;                                        // 0x04EC(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bEnableActiveRegion;                                      // 0x04F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x30];                                      // 0x07E0(0x0030) MISSED OFFSET
