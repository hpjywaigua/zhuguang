...
struct UIGameAnimAssetManager_UnloadAnimInGame_Params
{
};

// Function Gameplay.IGameAnimAssetManager.PreloadAnimInGame
struct UIGameAnimAssetManager_PreloadAnimInGame_Params
{
};

// Function Gameplay.IGameAnimAssetManager.OnRequestAsyncLoadCharacterDALoaded
struct UIGameAnimAssetManager_OnRequestAsyncLoadCharacterDALoaded_Params
{
	class AActor*                                      Owner;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Gameplay.IGameAnimAssetManager.OnAssetsLoaded
struct UIGameAnimAssetManager_OnAssetsLoaded_Params
{
