...
// (NetReliable, NetRequest, Exec, Native, Static, NetMulticast, Public, Delegate, NetServer, DLLImport, BlueprintCallable, NetValidate)
// Parameters:
...
void URankSmall_Integral_UIBP_C::STATIC_SetRankText(const struct FSlateColor& Color, const struct FSlateColor& ShadowColor, const struct FSlateFontInfo& FontInfo)
{
...
// (NetRequest, Native, Static, NetMulticast, Public, Delegate, NetServer, DLLImport, BlueprintCallable, NetValidate)
// Parameters:
...
void URankSmall_Integral_UIBP_C::STATIC_SetRankIntegral(const struct FBP_STRUCT_RankIntegralLevel_type& RankIntegralLevel_Info, bool isStarOpen)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
// (Native, Event, Static, MulticastDelegate, Private, NetServer, DLLImport, BlueprintCallable, NetValidate)
// Parameters:
