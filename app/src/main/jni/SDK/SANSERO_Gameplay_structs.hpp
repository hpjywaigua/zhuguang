...
enum class ECharacterMoveDragReason : uint8_t
{
	...
	ECharacterMoveDragReason__CMDR_MAX = 12
};
...
// Enum Gameplay.EnumAnimMotionType
enum class EnumAnimMotionType : uint8_t
{
	EnumAnimMotionType__None       = 0,
	EnumAnimMotionType__Jump       = 1,
	EnumAnimMotionType__Shovel     = 2,
	EnumAnimMotionType__Swim       = 3,
	EnumAnimMotionType__Parachute  = 4,
	EnumAnimMotionType__EnumAnimMotionType_MAX = 5
};
...
struct FDamageInfo
{
	...
	int                                                CircleIndex;                                              // 0x0058(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FGameModePlayerParams
{
	...
	struct FString                                     PIC_URL;                                                  // 0x0070(0x0010) (ZeroConstructor)
	int                                                Level;                                                    // 0x0080(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Segment_Level;                                            // 0x0084(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AceImprintShowId;                                         // 0x0088(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AceImprintBaseId;                                         // 0x008C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AvatarBoxId;                                              // 0x0090(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bAIPlayer;                                                // 0x0094(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0095(0x0003) MISSED OFFSET
	uint64_t                                           MLAIDisplayUID;                                           // 0x0098(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FGameModePlayerItem>                 ItemList;                                                 // 0x00A0(0x0010) (ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 fireworksInfo;                                            // 0x00B0(0x0010) (ZeroConstructor)
	TArray<int>                                        equip_plating_list;                                       // 0x00C0(0x0010) (ZeroConstructor)
	TArray<struct FGameModePlayerRolewearInfo>         AllWear;                                                  // 0x00D0(0x0010) (ZeroConstructor)
	int                                                RolewearIndex;                                            // 0x00E0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x00E4(0x0004) MISSED OFFSET
	TArray<struct FGameModePlayerExpressionItem>       ExpressionItemList;                                       // 0x00E8(0x0010) (ZeroConstructor)
	TArray<struct FGameModePlayerTaskData>             TaskDataList;                                             // 0x00F8(0x0010) (ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 WeaponAvatarList;                                         // 0x0108(0x0010) (ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 VehicleAvatarList;                                        // 0x0118(0x0010) (ZeroConstructor)
	TArray<struct FVehicleAvatarData>                  VehicleAdvanceAvatarList;                                 // 0x0128(0x0010) (ZeroConstructor)
	struct FGameModePlayerEquipmentAvatar              EquipmentAvatar;                                          // 0x0138(0x000C)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0144(0x0004) MISSED OFFSET
	TArray<struct FGameModeWeaponDIYPlanData>          WeaponDIYPlanData;                                        // 0x0148(0x0010) (ZeroConstructor)
	int                                                VehicleSkinInReady;                                       // 0x0158(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x015C(0x0004) MISSED OFFSET
	struct FGameModePlayerAliasInfo                    AliasInfo;                                                // 0x0160(0x0048)
	struct FGameModePlayerUpassInfo                    UpassInfo;                                                // 0x01A8(0x0038)
	struct FGameModePlayerPetInfo                      PetInfo;                                                  // 0x01E0(0x0020)
	TArray<struct FGameModePlayerPetInfo>              AdditionalPetInfo;                                        // 0x0200(0x0010) (ZeroConstructor)
	int                                                UsingAdditionalPetIndex;                                  // 0x0210(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x0214(0x0004) MISSED OFFSET
	TArray<struct FGameModePlayerKnapsackExtInfo>      KnapsackExtInfoList;                                      // 0x0218(0x0010) (ZeroConstructor)
	TArray<struct FGameModePlayeWeaponSchemeInfo>      WeaponSchemeInfoList;                                     // 0x0228(0x0010) (ZeroConstructor)
	int                                                CurWeaponSchemeIndex;                                     // 0x0238(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PveLevel;                                                 // 0x023C(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        CharSkillList;                                            // 0x0240(0x0010) (ZeroConstructor)
	struct FGameModePlayerBanChat                      banChat;                                                  // 0x0250(0x0018)
	struct FGameModePlayerBanChat                      banTarget;                                                // 0x0268(0x0018)
	TArray<struct FSpecialPickItem>                    SpecialPickItem;                                          // 0x0280(0x0010) (ZeroConstructor)
	struct FAchievementPrize                           EquippedAchievementPrize;                                 // 0x0290(0x000C)
	unsigned char                                      UnknownData08[0x4];                                       // 0x029C(0x0004) MISSED OFFSET
	TArray<int>                                        audioChat;                                                // 0x02A0(0x0010) (ZeroConstructor)
	struct FName                                       CurrentPlayerState;                                       // 0x02B0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       CurrentCharacterState;                                    // 0x02B8(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              SyncedTimestamp;                                          // 0x02C0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DestinyValue;                                             // 0x02C4(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              WarmScore;                                                // 0x02C8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              AIAllocMarkValue;                                         // 0x02CC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                LeaderCount;                                              // 0x02D0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x02D4(0x0004) MISSED OFFSET
	uint64_t                                           LastGameLeaderUID;                                        // 0x02D8(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<uint64_t>                                   LastGameTeammatesUID;                                     // 0x02E0(0x0010) (ZeroConstructor)
	uint64_t                                           LastGameBattleID;                                         // 0x02F0(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              RatingScore;                                              // 0x02F8(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bDoPlayerUseAutoFollow;                                   // 0x02FC(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x02FD(0x0003) MISSED OFFSET
	float                                              MaxRankingScore;                                          // 0x0300(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ObserverFlags;                                            // 0x0304(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           WatchPlayerKey;                                           // 0x0308(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsHawkEyeSpectator;                                      // 0x0310(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0311(0x0003) MISSED OFFSET
	int                                                HawkEyeSpectateMaxMatchCount;                             // 0x0314(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HawkEyeSpectateUsedMatchCount;                            // 0x0318(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      PlatformGender;                                           // 0x031C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x031D(0x0003) MISSED OFFSET
	int                                                planeAvatarId;                                            // 0x0320(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DyeDebugFlag;                                             // 0x0324(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     Nation;                                                   // 0x0328(0x0010) (ZeroConstructor)
	int                                                MatchLabel;                                               // 0x0338(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               OnlyTeammateSeeAvatar;                                    // 0x033C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x3];                                       // 0x033D(0x0003) MISSED OFFSET
	int64_t                                            LastGameResultTime;                                       // 0x0340(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CorpsID;                                                  // 0x0348(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CampID;                                                   // 0x0350(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bUsedSimulation;                                          // 0x0358(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bRoomCanKickPlayer;                                       // 0x0359(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCanDownloadInBattle;                                     // 0x035A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x5];                                       // 0x035B(0x0005) MISSED OFFSET
	struct FString                                     IpCountryStr;                                             // 0x0360(0x0010) (ZeroConstructor)
	bool                                               bRoomOwner;                                               // 0x0370(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x3];                                       // 0x0371(0x0003) MISSED OFFSET
	int                                                VeteranRecruitIndex;                                      // 0x0374(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MatchStrategyLabel;                                       // 0x0378(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x4];                                       // 0x037C(0x0004) MISSED OFFSET
	TArray<struct FDailyTaskStoreInfo>                 DailyTaskStoreList;                                       // 0x0380(0x0010) (ZeroConstructor)
	int                                                LandId;                                                   // 0x0390(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FollowType;                                               // 0x0394(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           FollowUID;                                                // 0x0398(0x0008) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           TaskSyncToDsTs;                                           // 0x03A0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x4];                                       // 0x03A4(0x0004) MISSED OFFSET
	uint64_t                                           LuckmateUID;                                              // 0x03A8(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     GameAPPIDFromDS;                                          // 0x03B0(0x0010) (ZeroConstructor)
	float                                              RealHiddenScore;                                          // 0x03C0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData18[0x4];                                       // 0x03C4(0x0004) MISSED OFFSET
};
...
// ScriptStruct Gameplay.AnimAssetDependencies
// 0x0090
struct FAnimAssetDependencies
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) MISSED OFFSET
	unsigned char                                      UnknownData01[0x28];                                      // 0x0000(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Gameplay.AnimAssetDependencies.Owner
	unsigned char                                      UnknownData02[0x60];                                      // 0x0030(0x0060) MISSED OFFSET
};

// ScriptStruct Gameplay.AnimDataChunk
// 0x0050
struct FAnimDataChunk
{
	TMap<int, class UAnimationAsset*>                  Datas;                                                    // 0x0000(0x0050) (ZeroConstructor)
};

// ScriptStruct Gameplay.PawnAnimData
// 0x0080
struct FPawnAnimData
{
	struct FGameplayTag                                KeyType;                                                  // 0x0000(0x0008) (Edit)
	unsigned char                                      UnknownData00[0x28];                                      // 0x0008(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Gameplay.PawnAnimData.StandAsset
	unsigned char                                      UnknownData01[0x28];                                      // 0x0030(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Gameplay.PawnAnimData.CrouchAsset
	unsigned char                                      UnknownData02[0x28];                                      // 0x0058(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Gameplay.PawnAnimData.ProneAsset
};

// ScriptStruct Gameplay.AnimBulkData
// 0x0030
struct FAnimBulkData
{
	struct FGameplayTag                                KeyType;                                                  // 0x0000(0x0008) (Edit)
	unsigned char                                      UnknownData00[0x28];                                      // 0x0008(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Gameplay.AnimBulkData.Asset
};

// ScriptStruct Gameplay.AnimMotionData
// 0x0018
struct FAnimMotionData
{
	EnumAnimMotionType                                 MotionType;                                               // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
	TArray<struct FAnimBulkData>                       Datas;                                                    // 0x0008(0x0010) (Edit, ZeroConstructor)
};

// ScriptStruct Gameplay.AnimCharacterData
// 0x0020
struct FAnimCharacterData
{
	TArray<struct FPawnAnimData>                       BaseDatas;                                                // 0x0000(0x0010) (Edit, ZeroConstructor)
	TArray<struct FAnimMotionData>                     AdditiveDatas;                                            // 0x0010(0x0010) (Edit, ZeroConstructor)
};
...
struct FPlayerVehAnimList
{
	...
	class UAnimationAsset*                             DyingInVehicleIdleAnim;                                   // 0x0160(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
{
	int8_t                                             AIType;                                                   // 0x03C4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03C5(0x0003) MISSED OFFSET
	uint32_t                                           AILevel;                                                  // 0x03C8(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLAIPlayer;                                              // 0x03CC(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLDelivery;                                              // 0x03CD(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x03CE(0x0002) MISSED OFFSET
	uint32_t                                           MLBotType;                                                // 0x03D0(0x0004) (ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Gameplay.AnimAssetChunkContext
// 0x0010
struct FAnimAssetChunkContext
{
	bool                                               bisFPP;                                                   // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	int                                                PoseType;                                                 // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BaseBit;                                                  // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Layer;                                                    // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Gameplay.AnimDataChunkAysncReq
// 0x0050
struct FAnimDataChunkAysncReq
{
	TMap<int, struct FSoftObjectPath>                  AysncReqs;                                                // 0x0000(0x0050) (ZeroConstructor)
};
