...
struct ULoadedClassManager_BP_C_LoadBPTableData_Mod_Params
{
...
struct ULoadedClassManager_BP_C_LoadVehilceRefitPartternBPTable_Params
{
	struct FString                                     BPTableName;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
};

// Function LoadedClassManager_BP.LoadedClassManager_BP_C.LoadVehilceRefitColorBPTable
struct ULoadedClassManager_BP_C_LoadVehilceRefitColorBPTable_Params
{
	struct FString                                     BPTableName;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
};

// Function LoadedClassManager_BP.LoadedClassManager_BP_C.LoadVehilceRefitParticleBPTable
struct ULoadedClassManager_BP_C_LoadVehilceRefitParticleBPTable_Params
{
	struct FString                                     BPTableName;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
};
