...
// Function LiveVideoPlugin.BP_LiveVideoLibrary.BP_LivePlayerSetVol
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// int                            nVolValue                      (Parm, ZeroConstructor, IsPlainOldData)
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int UBP_LiveVideoLibrary::BP_LivePlayerSetVol(int nVolValue)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function LiveVideoPlugin.BP_LiveVideoLibrary.BP_LivePlayerSetVol");

	UBP_LiveVideoLibrary_BP_LivePlayerSetVol_Params params;
	params.nVolValue = nVolValue;
