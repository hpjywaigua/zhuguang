...
void UBuildSystemComponent::ServerPlaceBuildActor(int BuildingIndex, const struct FVector& BuildLocation, const struct FRotator& BuildRotation, uint32_t InResult, int AvatarID, bool Relative)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
bool UBuildingActorInterface::BPCheckPlacement(class UWorld* World, const struct FTransform& tranx, int CheckType, int CurrentAvatarID)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
