...
public:
	...
	struct FScriptMulticastDelegate                    OnPostSwitchGameStatusStartEvent;                         // 0x0138(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPostSwitchGameStatusEvent;                              // 0x0148(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPreSwitchGameStatusEvent;                               // 0x0158(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData04[0x10];                                      // 0x0168(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnGameStatusSwitchTerminate;                              // 0x0178(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPreSwitchGameStatusEndEvent;                            // 0x0188(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnCreateLogicManagerListEvent;                            // 0x0198(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnSetGameStatusEvent;                                     // 0x01A8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAddLuaLogicManagerEvent;                                // 0x01B8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRemoveLuaLogicManagerEvent;                             // 0x01C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UWorld*                                      CurrentGameStatusWorld;                                   // 0x01D8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x8];                                       // 0x01E0(0x0008) MISSED OFFSET
...
public:
	...
	TMap<struct FString, class UProperty*>             NameToProperty;                                           // 0x00B8(0x0050) (ZeroConstructor)
