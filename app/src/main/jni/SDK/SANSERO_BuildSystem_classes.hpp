...
public:
	...
	bool                                               bSkipCheckOwnerCollision;                                 // 0x04E9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x04EA(0x0006) MISSED OFFSET
...
{
public:
	TArray<struct FBuildingActorInfo>                  BuildingActorList;                                        // 0x03F8(0x0010) (ZeroConstructor)
...
{
public:
	struct FVector                                     BuildCenterOffset;                                        // 0x0810(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	class UParticleSystemComponent*                    SelectBuildEffect;                                        // 0x03F8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
