...
{
public:
	class UMediaPlaneComponent*                        MediaPlane;                                               // 0x03F8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0xC0];                                      // 0x07E0(0x00C0) MISSED OFFSET
